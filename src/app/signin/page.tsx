                 ...
                 {tokenLoading ? (
                   ...
                   <div className="relative z-10">
                     ...
                     <form onSubmit={submit} className={`space-y-3.5 sm:space-y-4 md:space-y-5 transition-opacity duration-200 ${(loading || redirecting) ? 'opacity-90' : 'opacity-100'}`}>
                       ...
                       {/* Info Message - User not found (shown with red styling) */}
                       {info && (
                         <div id="email-info" role="alert" aria-live="polite" className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                           <div className="flex">
